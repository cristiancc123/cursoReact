...
//import './estilos/app_ejercicio18.css'
import moduloCss18 from './estilos/app_ejercicio18.module.css'

console.log(moduloCss18);
...
const Image = ({ image }) => (
  <div className={moduloCss18.card}>
    <img
      src={image.source}
      alt='Imagen'
      className={moduloCss18.image}
    />
    <div className={moduloCss18.footer}>
      <img
        src={image.author.avatar}
        alt='Avatar'
        className={moduloCss18.avatar}
      />
      <div>
        {image.author.name}
      </div>
...
class App extends Component {
  render () {
    return (
      <div className={moduloCss18.images}>
        {images.map(image => (
          <Image
            image={image}
            key={image.id}
